    ...
    <ul class="space-y-4 p-4 lg:flex-grow" id="navLinks">
        <li class="home">
            <a href="#home" title="Home" class="block px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded">Home</a>
        </li>
        <li class="projects">
    ...
    <div class="p-4 border-t border-gray-700">
        <div class="flex justify-center justify-between text-gray-300">
            <a href="https://www.linkedin.com/in/fvarli/" target="_blank" aria-label="LinkedIn" title="LinkedIn" rel="noopener noreferrer" class="hover:text-gray-400">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M9.237 8.855v12.139h3.769v-6.003c0-1.584.298-3.118 2.262-3.118 1.937 0 1.961 1.811 1.961 3.218v5.904H21v-6.657c0-3.27-.704-5.783-4.526-5.783-1.835 0-3.065 1.007-3.568 1.96h-.051v-1.66H9.237zm-6.142 0H6.87v12.139H3.095z"></path>
                    <circle cx="4.983" cy="5.009" r="2.188"></circle>
                </svg>
            </a>
            <a href="https://github.com/fvarli" target="_blank" aria-label="GitHub" title="GitHub" rel="noopener noreferrer" class="hover:text-gray-400">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.fiverr.com/f_varli" target="_blank" aria-label="Upwork" title="Fiverr" rel="noopener noreferrer" class="hover:text-gray-400" style="filter: invert(1)">
            ...
            <a href="https://instagram.com/f_varli" target="_blank" aria-label="Instagram" title="Instagram" rel="noopener noreferrer" class="hover:text-gray-400" style="filter: invert(1)">
